...
var GrandaMentoWrapper = /** @class */ (function (_super) {
    ...
    function GrandaMentoWrapper() {
        ...
        _this.approver = BaseWrapper_1.proxyCall(_this.contract.methods.approver);
        _this.setApprover = BaseWrapper_1.proxySend(_this.kit, _this.contract.methods.setApprover);
        _this.maxApprovalExchangeRateChange = BaseWrapper_1.proxyCall(_this.contract.methods.maxApprovalExchangeRateChange, undefined, BaseWrapper_1.fixidityValueToBigNumber);
        _this.setMaxApprovalExchangeRateChange = BaseWrapper_1.proxySend(_this.kit, _this.contract.methods.setMaxApprovalExchangeRateChange);
        _this.spread = BaseWrapper_1.proxyCall(_this.contract.methods.spread, undefined, BaseWrapper_1.fixidityValueToBigNumber);
        _this.setSpread = BaseWrapper_1.proxySend(_this.kit, _this.contract.methods.setSpread);
        _this.vetoPeriodSeconds = BaseWrapper_1.proxyCall(_this.contract.methods.vetoPeriodSeconds, undefined, BaseWrapper_1.valueToBigNumber);
        _this.setVetoPeriodSeconds = BaseWrapper_1.proxySend(_this.kit, _this.contract.methods.setVetoPeriodSeconds);
        _this.exchangeProposalCount = BaseWrapper_1.proxyCall(_this.contract.methods.exchangeProposalCount, undefined, BaseWrapper_1.valueToBigNumber);
        _this.setStableTokenExchangeLimits = BaseWrapper_1.proxySend(_this.kit, _this.contract.methods.setStableTokenExchangeLimits);
        _this.approveExchangeProposal = BaseWrapper_1.proxySend(_this.kit, _this.contract.methods.approveExchangeProposal);
        _this.executeExchangeProposal = BaseWrapper_1.proxySend(_this.kit, _this.contract.methods.executeExchangeProposal);
        _this.cancelExchangeProposal = BaseWrapper_1.proxySend(_this.kit, _this.contract.methods.cancelExchangeProposal);
        return _this;
    }
    ...
    GrandaMentoWrapper.prototype.createExchangeProposal = function (stableTokenRegistryId, sellAmount, sellCelo) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                createExchangeProposalInner = BaseWrapper_1.proxySend(this.kit, this.contract.methods.createExchangeProposal);
    ...
    GrandaMentoWrapper.prototype.getHumanReadableExchangeProposal = function (exchangeProposalID) {
        return __awaiter(this, void 0, void 0, function () {
            var proposal, stableTokenContract, _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, this.getExchangeProposal(exchangeProposalID)];
                    case 1:
                        proposal = _d.sent();
                        stableTokenContract = new StableTokenWrapper_1.StableTokenWrapper(this.kit, StableToken_1.newStableToken(this.kit.connection.web3, proposal.stableToken));
                    ...
                    case 3: return [2 /*return*/, __assign.apply(void 0, _a.concat([(_b.stableToken = _c + (_d.sent()) + ") at " + proposal.stableToken, _b.implictPricePerCelo = proposal.sellCelo
                                ? proposal.buyAmount.div(proposal.sellAmount)
                                : proposal.sellAmount.div(proposal.buyAmount), _b.state = ExchangeProposalState[proposal.state], _b)]))];
                }
            });
        });
    };
