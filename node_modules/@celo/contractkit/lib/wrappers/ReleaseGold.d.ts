...
export declare class ReleaseGoldWrapper extends BaseWrapper<ReleaseGold> {
     ...
     * @param value The amount of gold to revoke.
     */
    revokePendingVotes: (group: string, value: BigNumber) => Promise<CeloTransactionObject<void>>;
    /**
     ...
     * @param value The amount of gold to revoke.
     */
    revokeActiveVotes: (group: string, value: BigNumber) => Promise<CeloTransactionObject<void>>;
    /**
     ...
     * @param value The amount of gold to revoke.
     */
    revokeValueFromVotes: (group: string, value: BigNumber) => Promise<CeloTransactionObject<void>[]>;
    revokeAllVotesForGroup: (group: string) => Promise<CeloTransactionObject<void>[]>;
