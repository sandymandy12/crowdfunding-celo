...
var ReserveWrapper = /** @class */ (function (_super) {
    ...
    function ReserveWrapper() {
         ...
         */
        _this.getAssetAllocationWeights = BaseWrapper_1.proxyCall(_this.contract.methods.getAssetAllocationWeights, undefined, function (weights) { return weights.map(BaseWrapper_1.valueToBigNumber); });
        /**
         * @notice Returns a list of token symbols that have been allocated.
         * @return An array of token symbols that have been allocated.
         */
        _this.getAssetAllocationSymbols = BaseWrapper_1.proxyCall(_this.contract.methods.getAssetAllocationSymbols, undefined, function (symbols) { return symbols.map(_this.kit.web3.utils.hexToAscii); });
        /**
